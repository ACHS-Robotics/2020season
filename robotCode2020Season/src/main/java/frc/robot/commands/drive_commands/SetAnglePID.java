...
public class SetAnglePID extends PIDCommand {
   ...
   */
  private static double turnP = 0.023, turnI = 0, turnD =0.00115, setpoint = 0;
  private S_Drive sub;

  public SetAnglePID(S_Drive sub) { // TODO: make continuously editable pid values
    ...
    super(
      ...
      () -> SmartDashboard.getNumber("turnSetpoint", setpoint), //for tuning
